...
# 2. Calculate the KLD distances between each motif in two given operons, and take the:
#       a. average of all the distances between all motifs
#       b. minimum of all the distances between all motifs
#       c. maximum of all the distances between all motifs
#       d. median of all the distances between all motifs
...
# 3. Write nodes and edges csv file for each different distance calculation
